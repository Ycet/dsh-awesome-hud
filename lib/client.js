...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// 菜单可隐藏的模块（会话模块恒展示）
		const MODULE_KEYS = ["context", "balance", "git", "subagents", "tasks", "mcp"];
		...
		function apply(ctx) {
			...
			function BalanceModule(props) {
				...
				return react.createElement("div", { className: "hud-section" },
					...
					props.fold ? null : react.createElement("div", { className: "hud-module-body" },
						balance !== null && balance.available === true
							? (balance.error === null
						...
						ocUsable && oc !== null
							? react.createElement(react.Fragment, null,
								react.createElement("div", { className: "hud-row hud-usage-row" },
									...
									react.createElement("span", { className: "hud-balance-value" }, fmtOcPercent(oc.rolling))),
								react.createElement("div", { className: "hud-row hud-usage-row" },
									react.createElement(Icon, { name: "icon-opencode" }), react.createElement("span", { className: "hud-row-label" }, t("ocWeekly")),
									react.createElement("span", { className: "hud-balance-value" }, fmtOcPercent(oc.weekly))),
								react.createElement("div", { className: "hud-row hud-usage-row" },
									react.createElement(Icon, { name: "icon-opencode" }), react.createElement("span", { className: "hud-row-label" }, t("ocMonthly")),
									react.createElement("span", { className: "hud-balance-value" }, fmtOcPercent(oc.monthly))))
							: null),
					jumpMenu);
			}

			function loadStoredFolds() {
				const fallback = { git: false, subagents: false, tasks: false, mcp: false, usage: false }; // MCP/用量 默认展开
				try {
				...
				return react.createElement("section", {
					...
					react.createElement("div", { className: "hud-panel-body", ref: bodyRef, onScroll: onPanelScroll },
						...
						activeModules.balance === false
							...
							? null
							: react.createElement(BalanceModule, { balance, opencode, fold: folds.usage, onFoldChange: (value) => setFolds((prev) => ({ ...prev, usage: value })) }),
