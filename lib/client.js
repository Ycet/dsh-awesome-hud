				...
				react.useEffect(() => {
					...
					const update = () => {
						...
						if (compRect !== undefined && compRect.bottom > nextTop + 120) {
							setLimitH(Math.round(compRect.bottom - nextTop));
						} else {
							setLimitH(null);
						}
					};
