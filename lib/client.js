...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			collapseModule: "折叠",
			closeModal: "关闭",
			tasksSummary: "{done} 已完成·{active} 执行中·{pending} 待处理",
			plansModule: "计划清单",
			plansDiscarded: "已废弃",
			plansPending: "待审批",
			plansApproved: "已执行",
